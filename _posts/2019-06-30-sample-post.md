...
Depois de diversas tentativas, encontrarmos a forma correta de criar um blog. É simples: leia TODAS, eu disse TODAS as instruções corretamente. Caso você não faça isso, irá passar raiva. 
